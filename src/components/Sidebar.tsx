...
function Sidebar({
  ...
  return (
    <div style={{ width: 300, background: '#0f172a', borderRight: '1px solid rgba(255,255,255,0.1)', display: 'flex', flexDirection: 'column', zIndex: 10, flexShrink: 0, overflowY: 'auto' }}>
      <div style={{ padding: 20, display: 'flex', flexDirection: 'column', gap: 16 }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderTop: '1px solid rgba(255,255,255,0.1)', paddingTop: 16 }}>
          ...
          <button
            ...
            style={{ background: 'none', border: '1px solid rgba(239,68,68,0.3)', color: '#fca5a5', borderRadius: 6, padding: '4px 8px', fontSize: 10, cursor: 'pointer' }}
